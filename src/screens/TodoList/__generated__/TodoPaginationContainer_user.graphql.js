...
declare export opaque type TodoPaginationContainer_user$ref: FragmentReference;
...
|};
export type TodoPaginationContainer_user$data = TodoPaginationContainer_user;
export type TodoPaginationContainer_user$key = {
  +$data?: TodoPaginationContainer_user$data,
